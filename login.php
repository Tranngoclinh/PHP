...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $confirm = $_REQUEST['conf_pass_us'];
    if ($email == "nguyenlinh23444@gmail.com" && $password == "88888888") {
        echo "<h3>  Xin Chào <span style='color:red'>" .$email. "</span> </h3>";
    } else{
